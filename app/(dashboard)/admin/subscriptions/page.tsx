...
export default async function AdminSubscriptionsPage({
  ...
  const { data: subs, total, page, pageSize, totalPages } = await listSubscriptions(sp);

  return (
    <AdminListLayout
      title="Subscriptions"
      total={total}
      searchPlaceholder="Search by org or plan..."
      extraFilters={<StatusFilter options={STATUS_OPTIONS} />}
    >
      {subs.length === 0 ? (
        <Card>
